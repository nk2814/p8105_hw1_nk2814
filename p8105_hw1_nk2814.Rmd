...
# Convert logical vector norm_samp_pos to numeric vector called logical_num
...
# Multiply the random sample norm_samp by the previous result

# First, pull norm_samp from our data frame so that it exists in our R environment

norm_samp = pull(problem1_df, norm_samp)

# Now, we can multiply our random sample norm_samp by our logical numeric vector

logical_num*norm_samp
